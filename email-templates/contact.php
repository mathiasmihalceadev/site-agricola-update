...
<?php 
  if(isset($_POST['email'])){
	...
	$receiver="suport@gradinacualune.ro";
	$subject="Completare formular de contact - gradinaculune.ro";
	...
	<tr>
	<td colspan='2' align='center' valign='top'><img style=' margin-top: 15px; ' src='http://gradinacualune.ro/images/logo.png' ></td>
	</tr>
	<tr>
...
$headers .= 'From: <'.$from.'>' . "\r\n";
   ...
   {	
   	 //Fail Message
      echo "A apărut o eroare. Te rugăm să reîncerci mai târziu.";
   }
